...
public class Factura extends Equipo {
    ...
    public Factura(String id, String nombre, int stock, double precio, int cantidad, String categoria, String estado) {
        super(id, nombre, stock, precio, cantidad, categoria, estado);
        this._numeroFactura = _numeroFactura;
